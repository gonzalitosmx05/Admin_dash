      ...
      <form action="" id="clienteForm">
        <div class="modal-body">        
          <div class="form-group">
              ...
              <input required type="text" class="form-control" id="nombreCNew" placeholder="Nombre">
          </div>    
          <div class="form-group">
              <label class="d-block text-center" for="telefonoCliente">Telefono</label>
              <input type="text" class="form-control" id="telefonoCNew" placeholder="Telefono">
          </div>     
          <div class="form-group">
              <label class="d-block text-center" for="telefono2Cliente">Telefono 2</label>
              <input type="text" class="form-control" id="telefono2CNew" placeholder="Telefono 2">
          </div>                
          <div class="form-group">
              <label class="d-block text-center" for="correoCliente">Correo</label>
              <input type="email" class="form-control" id="correoCNew" placeholder="Correo">
          </div>                    
        </div>
        <div class="modal-footer">
          <button id="btnRgisCLient" class="btn btn-primary">Guardar</button>
